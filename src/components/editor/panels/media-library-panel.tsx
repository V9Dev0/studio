    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        const newMediaItem: UploadedMediaItem = {
          ...
          title: file.name,
          type: file.type,
          thumbnailUrl: file.type.startsWith('image/') ? dataUri : 'https://placehold.co/100x60.png?text=Media', // Basic thumbnail
          dataUri: dataUri,
          dataAiHint: file.type.startsWith('image/') ? "uploaded image" : "uploaded video",
        };
